...
class escamboMVC
{
	...
	public function __construct () {	
		...
		if ( ! file_exists( escambo_route()->controller . $this->controlador . '.php' ) ) {
			
			require_once escambo_route()->www . $this->not_found;
		...
		require_once escambo_route()->controller . $this->controlador . '.php';
